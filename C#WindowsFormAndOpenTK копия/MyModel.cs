...
namespace C_WindowsFormAndOpenTK
{
    ...
    public class MyTransform
    {
        ...
        public MyTransform() { myPosition = new Vector3(); myRotation = new Vector3(); myScale = new Vector3(); }
    }
    ...
    public class MyModel
    {
        ...
        private MyTransform myTransformBase;

        public MyTransform myTransform { get { return myTransformBase; } set { myTransformBase = value; } }
        ...
        public MyModel(string path)
        {
            ...
            myTransformBase = new MyTransform();
        }

        public MyModel(string path, MyShader _myShader)
        {
            textures_loaded = new List<MyTestTexture>();
        ...
        {
            myModel = Matrix4.Identity;
            myModel = myModel * Matrix4.CreateTranslation(myTransformBase.myPosition);
            myModel = myModel * Matrix4.CreateScale(myTransformBase.myScale);
            myModel = myModel * Matrix4.CreateFromQuaternion(
                OpenTK.Quaternion.FromEulerAngles(myTransformBase.myRotation));
        }
        ...
        public void Draw(Matrix4 _view, Matrix4 _projection)
        {
            myShader.Use();
